...
# from vllm_mindspore.model_executor.models.mindway_models.qwen2_5_vl import Qwen2_5_VisionTransformer #TBD???
...
from vllm_mindspore.model_executor.models.mindway_models.qwen2 import MindWAYModelBase, Fake_Attention
...
from vllm.model_executor.models.interfaces import MultiModalEmbeddings, SupportsPP # TODO
from vllm.model_executor.models.utils import AutoWeightsLoader, init_vllm_registered_model # TODO
from vllm.attention.backends.abstract import AttentionMetadata
from vllm.model_executor.models.qwen2_5_omni_thinker import (
    # _qwen2_5_omni_thinker_field_config,
    Qwen2_5OmniThinkerProcessingInfo,
    # Qwen2_5OmniThinkerMultiModalDataParser,
    # Qwen2_5OmniThinkerDummyInputsBuilde,
    Qwen2_5OmniThinkerMultiModalProcessor
)

# import from mindway
# TODO: remove in future when mindway is installed
import os, sys
mindway_lib_path = os.path.abspath("../../../../../mindway/")
sys.path.insert(0, mindway_lib_path)
from mindway.transformers.models.qwen2_5_omni.modeling_qwen2_5_omni import Qwen2_5OmniThinkerForConditionalGeneration as MindWAY_Qwen2_5OmniThinkerForConditionalGeneration
from mindway.transformers.models.qwen2_5_omni.modeling_qwen2_5_omni import Qwen2_5OmniAudioEncoder, Qwen2_5OmniVisionEncoder, Qwen2_5OmniThinkerTextModel
from mindway.transformers.models.qwen2_5_vl.modeling_qwen2_5_vl import Qwen2_5_VisionTransformerPretrainedModel


# import from transformers (master, transformers-4.52.0.dev0)
...
#     Qwen2_5OmniThinkerMultiModalDataParser,
# )
# from transformers.models.whisper import WhisperFeatureExtractor # TODO: incld torch
...
# def _qwen2_5_omni_thinker_field_config(hf_inputs: Mapping[str, mindspore.Tensor]):
#     audio_feature_lengths = hf_inputs.get("audio_feature_lengths",
#                                           ops.empty((0, )))

#     image_grid_thw = hf_inputs.get("image_grid_thw", ops.empty((0, 3)))
#     image_grid_sizes = image_grid_thw.prod(-1)

#     video_grid_thw = hf_inputs.get("video_grid_thw", ops.empty((0, 3)))
...
#         self,
#         data: Union[dict[str, mindspore.Tensor], ModalityData[ImageItem]],
...
#             assert isinstance(feature_attention_mask, mindspore.Tensor)
#             _, audio_output_lens = _get_feat_extract_output_lengths(
...
#             assert isinstance(grid_thw, mindspore.Tensor)
...
class Qwen2_5OmniConditionalGenerationMixin:
    ...
    def _parse_and_validate_audio_input(
        ...
        if not isinstance(input_audio_features, (mindspore.Tensor, list)):
    ...
    def _process_audio_input(
        ...
        cached_audio_features: mindspore.Tensor = None,
    ) -> mindspore.Tensor:
    ...
    def _process_image_input(
            self,
            image_input: Qwen2_5_VLImageInputs) -> tuple[mindspore.Tensor, ...]:
    ...
    def _process_video_input(
            ...
            cached_video_embeds: mindspore.Tensor = None) -> mindspore.Tensor:
...
class NEW_MindWAY_Qwen2_5OmniThinkerForConditionalGeneration(MindWAY_Qwen2_5OmniThinkerForConditionalGeneration):
    ...
    def __init__(self, config):
        ...
        self.visual = Qwen2_5OmniVisionEncoder(config.vision_config) # Qwen2_5_VisionTransformer  ????
        self.vocab_size = config.text_config.vocab_size
        config.text_config._attn_implementation = config._attn_implementation
        # replace text model to qwen2 vLLM (with PA)
        # self.model = Qwen2_5OmniThinkerTextModel(config.text_config)
        self.model = vLLMQwen2Model(config.text_config)
...
class Qwen2_5OmniThinkerForConditionalGeneration(
        MindWAYModelBase, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        thinker_config.audio_config._attn_implementation = thinker_config._attn_implementation #"flash_attention_2"
        ...
        # )
        mindway_model = NEW_MindWAY_Qwen2_5OmniThinkerForConditionalGeneration.from_pretrained(
            thinker_config,
            mindspore_dtype=mindspore.bfloat16)
        self.audio_tower = mindway_model.audio_tower
    ...
    def get_multimodal_embeddings(
        ...
        multimodal_embeddings: tuple[mindspore.Tensor, ...] = ()
